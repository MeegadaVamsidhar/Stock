            ...
            <div className='container p-5 border-top mt-5'>
                <div className='row mt-5 text-muted'>
                    <div className='col'>
                        ...
                        <p>&copy;2025, Stock-Matters Broking Ltd.All rights reserved.</p>
                    </div>
                    <div className='col'>
                        <p>Account</p>
                        <ul className='p-0'>
                            ...
                            <a href='' style={{textDecoration:"none"}}>Demateriaasation</a><br />
                    ...
                    <div className='col'>
                        ...
                        <ul className='p-0'>
                            ...
                            <a href='' style={{textDecoration:"none"}}>Stock-Matters Cares (CSR)</a><br />
                            <a href='' style={{textDecoration:"none"}}>Stock-Matters.tech</a><br />
                    ...
                    <div className='col'>
                        ...
                        <ul className='p-0'>
                            ...
                            <a href='' style={{textDecoration:"none"}}>Market hoadays</a><br />
                ...
                <div className='mt-5 text-muted p-5'style={{fontSize:"11px"}}>
                    <div className='row'>
                        <p>Stock-Matters Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Stock-Matters Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Stock-Matters Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@Stock-Matters.com, for DP related to dp@Stock-Matters.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
                        ...
                        <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Stock-Matters and offering such services, please create a ticket here.</p>
